...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'bourboneat' ),
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'bourboneat' ); ?></p>
	<?php endif; ?>
